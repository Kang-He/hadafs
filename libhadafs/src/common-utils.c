...
static hadafs_ctx_t *gf_global_ctx;
 ...
 * not set gf_global_ctx since there can be multiple hadafs-contexts 
...
void
gf_print_backtrace_debug (char *startmsg)
{
...
gf_print_trace (int32_t signum)
{
	...
	{
		extern hadafs_ctx_t *gf_global_ctx;
		hadafs_ctx_t *ctx = gf_global_ctx;
